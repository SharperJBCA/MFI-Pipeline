...
if __name__ == '__main__':
    ...
    caldir = '/nas/scratch/sharper/QUIJOTE/datos/caltod/'
    ...
    for f in files:
        ...
        for horn in range(2):
            ...
            for ch in channels:
                ...
                RFImask = Masking.GetRingNoiseMask(data['DATA'][0,:,horn*4 + ch],
                                                   data['JD'][0,:,0]*24.*3600.,
                                                   bl,mask,foremask,
                                                   std_cutoff=cutoffs[horn*4 + ch]*2.,
                                                   peak_cutoff= peaks[horn*4 + ch]*2.)
               
                data['MASK'][0,:,horn*4 + ch] = (RFImask & mask)     
